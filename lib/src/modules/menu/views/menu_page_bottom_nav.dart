...
/// Menu page with bottom navigation and integrated settings drawer.
///
/// This version includes theme, language, and logout directly in the
/// settings drawer without importing from other modules.
class MenuPageWithBottomNavComplete extends GetWidget<MenuViewModel> {
  /// Creates a [MenuPageWithBottomNavComplete].
  const MenuPageWithBottomNavComplete({super.key});
      ...
      endDrawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            // You can import ThemeDrawerItem, LanguageDrawerItem, LogoutDrawerItem here
